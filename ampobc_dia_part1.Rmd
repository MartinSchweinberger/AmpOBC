...
```{r ampobc_1_01b, message=F, warning=F}
head(corpusfiles)
```
...
```{r ampobc_1_02, message=F, warning=F}
# extract speakers
Speaker <- as.vector(unlist(sapply(obc, function(x) {
  x <- gsub(">.*", "", x)
  x <- gsub(".*#", "", x)
  x <- gsub(".*:", "", x)
  })))
# extract raw text
Text <- as.vector(unlist(sapply(obc, function(x) {
...
obcdf <- data.frame(File, Speaker, Text, CleanText)
...
pos01 <- obcdf$CleanText[1:10000]
pos02 <- obcdf$CleanText[10001:20000]
pos03 <- obcdf$CleanText[20001:22000]
pos04 <- obcdf$CleanText[22001:23000]
pos05 <- obcdf$CleanText[23001:24000]
pos06 <- obcdf$CleanText[24001:25000]
pos07 <- obcdf$CleanText[25001:30000]
pos08 <- obcdf$CleanText[30001:40000]
pos09 <- obcdf$CleanText[40001:50000]
pos10 <- obcdf$CleanText[50001:60000]
pos11 <- obcdf$CleanText[60001:70000]
pos12 <- obcdf$CleanText[70001:80000]
pos13 <- obcdf$CleanText[80001:90000]
pos14 <- obcdf$CleanText[90001:100000]
pos15 <- obcdf$CleanText[100001:nrow(obcdf)]
```
...
# chunk 14
obcpos14 <- POStag(object = pos14)
obcpos14 <- as.vector(unlist(obcpos14))
writeLines(obcpos14, con = here::here("data", "obcpos14.txt"), sep = "\n", useBytes = FALSE)
# chunk 15
obcpos15 <- POStag(object = pos15)
obcpos15 <- as.vector(unlist(obcpos15))
writeLines(obcpos15, con = here::here("data", "obcpos15.txt"), sep = "\n", useBytes = FALSE)
...
postag.files = c(here::here("data", "obcpos01.txt"), here::here("data", "obcpos02.txt"), 
                 ...
                 here::here("data", "obcpos13.txt"), here::here("data", "obcpos14.txt"),
                 here::here("data", "obcpos15.txt"))
